...
[
  {
    ...
    "body": [
      ...
      "When you pay for a question the amount is held, not sent. It is locked in a contract on the Base network in USDC, and it reaches the verifier only when you confirm their evidence, less our 10%. If nobody delivers inside the window you set, you take the whole amount back.",
      ...
      "WHERE LIABILITY CANNOT BE EXCLUDED, IT IS CAPPED. Our total liability to you for any claim is limited to the greater of the amount you paid us in fees on the specific question the claim concerns, or â‚¦10,000. This cap applies however the claim is framed, in contract, in negligence or otherwise.",
